...
| HN-REM-010 | Wave 3 | J. Medication Reminders | Appointment reminder | Implemented & Working | 🟢 COMPLETED | P3 | V1.2 | Remaining: Android E2E | PARTIALLY VERIFIED | STATUS.md | Appointments CRUD + local one-shot via LocalReminderNotifications (id 2e6+id); REM10 backend/Flutter tests; no FCM |
