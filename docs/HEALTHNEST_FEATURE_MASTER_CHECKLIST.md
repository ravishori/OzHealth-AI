...
| HN-FUTURE-001 | Wave 3 | Y. Future / Planned Features | Symptom checker | Implemented & Working | 🟢 COMPLETED | P2 | V1.2 | Remaining: Android E2E / formal clinical review | PARTIALLY VERIFIED | STATUS.md | Safety-hardened UI+`POST /symptoms/check`; HN-AI-010 fencing; privacy-safe logs; CALL 000 escalation; SYM tests PASS |
