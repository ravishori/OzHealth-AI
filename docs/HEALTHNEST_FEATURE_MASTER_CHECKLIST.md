...
| HN-FAMILY-010 | Wave 3 | C. Family Health Management | Switch active family profile | Implemented & Working | 🟢 COMPLETED | P2 | V1.2 | Remaining: Android E2E; broader feature consumers | PARTIALLY VERIFIED | S8-L1 | Client Active Subject store + drawer switcher; Hive id-only persistence; logout clears; unowned/inactive rejected client-side; server ownership helpers remain authoritative; no subject API/migration; host tests PASS; Android BLOCKED |
