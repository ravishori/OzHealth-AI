...
| HN-MED-009 | Wave 3 | G. Medicine Intelligence | Medicine favourites | Implemented & Working | 🟢 COMPLETED | P3 | V1.2 | Remaining: Android E2E on emulator/device | PARTIALLY VERIFIED | S6-S5 | `medicine_favourites` + UNIQUE(user,medicine); GET/POST/DELETE `/medicines/.../favourite` + list; detail star + favourites screen; host tests PASS; Android BLOCKED |
