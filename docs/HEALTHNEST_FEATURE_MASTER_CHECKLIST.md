...
| HN-HEALTH-005 | Wave 1 | K. Health Monitoring | Edit metric | Implemented & Working | 🟢 COMPLETED | P2 | V1.0 | Remaining: Android E2E on emulator/device | PARTIALLY VERIFIED | HN-HEALTH-005 | PUT `/{id}` owner-scoped; type + family subject frozen; editable value/value2/unit/notes/recorded_at; summary/trend cache invalidated; HEALTH5-01..23 + HEALTH5-F01..F10 host PASS; Android E2E PENDING |
