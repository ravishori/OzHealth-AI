...
| HN-FUTURE-003 | Wave 3 | Y. Future / Planned Features | Health insights | Implemented & Working | 🟢 COMPLETED | P2 | V1.2 | Remaining: Android E2E / formal clinical review | PARTIALLY VERIFIED | STATUS.md | Grounded metrics+adherence+confirmed-lab facts; INS tests PASS |
