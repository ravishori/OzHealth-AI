...
| HN-RX-003 | Wave 1 | E. Prescription Management | Manual prescription entry | Implemented & Working | 🟢 COMPLETED | P2 | V1.0 | Remaining: Android E2E on emulator/device | PARTIALLY VERIFIED | S6-S5 | `POST /prescriptions/manual` + Flutter entry/review; Self/family ownership via `_require_owned_active_family_member`; coexists with OCR; host tests PASS; Android BLOCKED |
