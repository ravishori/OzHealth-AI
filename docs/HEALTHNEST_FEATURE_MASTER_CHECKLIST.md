...
| HN-REM-010 | Wave 3 | J. Medication Reminders | Appointment reminder | Implemented & Working | 🟢 COMPLETED | P3 | V1.2 | Remaining: Android E2E on stable emulator/device | PARTIALLY VERIFIED | HN-REM-010 | Appointments CRUD + local one-shot via LocalReminderNotifications (`2_000_000+id`); permission-denied honest UX; REM10 backend/Flutter host PASS; no FCM; Android E2E PENDING |
