...
// 40% opacity of emergencyRed (#E53935) = 0x66E53935
const Color _emergencyRedShadow = Color(0x66E53935);
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: const [BoxShadow(color: _emergencyRedShadow, blurRadius: 10, offset: Offset(0, 4))],
        ),
        child: const Row(
          children: [
