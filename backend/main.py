...
from app.api.routes import (
    ...
    medicines, reminders, medication_history, health_metrics, ai_assistant,
...
from app.models.medication_dose_event import MedicationDoseEvent as _medication_dose_event_model  # noqa: F401
...
app.include_router(
    ...
    prefix=f"{PREFIX}/medication-history",
